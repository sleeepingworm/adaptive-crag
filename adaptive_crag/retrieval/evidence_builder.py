...
def build_evidence(query: str, ranked_chunks: list[dict], source: str = "hybrid") -> dict:
    ...
    for item in ranked_chunks:
        ...
        source_label = _make_source_label(filename, page_num)
...
def _make_source_label(filename: str, page_num: int | None) -> str:
    """生成给 LLM 看的来源短标签，如 'CRAG_paper.pdf，第 3 页'"""
    label = filename or "未知文件"
