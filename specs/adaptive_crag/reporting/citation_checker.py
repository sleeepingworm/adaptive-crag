...
class CitationChecker:
    ...
    def check_report(self, report: str, citations: list[dict]) -> dict:
        ...
        return {
            ...
            "unverified_claims": self._find_unverified_claims(report, citations),
        }
    ...
    def _find_unverified_claims(self, report: str, citations: list[dict]) -> list[dict]:
        """查找报告中没有引用标注的结论"""
        # 简单实现：查找无 [数字] 标注的段落
        import re
